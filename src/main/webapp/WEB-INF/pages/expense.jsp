                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <form:select path="category" cssClass="form-control">
                                    ...
                                    <form:option value="Food"/>
                                    <form:option value="Car"/>
                                    <form:option value="Transport"/>
                                    <form:option value="Food for pet"/>
                                    <form:option value="Goods"/>
                                    <form:option value="Services"/>
                                    <form:option value="Rest"/>
                                </form:select>
                            </div>
                        </div>
                        <div class="footer text-center">
                            <button class="btn btn-danger btn-wd btn-lg" type="submit">
                                Ok
